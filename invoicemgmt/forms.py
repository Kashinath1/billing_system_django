...
class InvoiceForm(forms.ModelForm):
	class Meta:
		model = Invoice
		fields = ['name','amount_with_tax','amount_without_tax','type_of_sales', 'phone_number', 'invoice_date','invoice_number',
				'total', 'paid', 'invoice_type','balance'
				]
  
#   fields  may required = # 'line_one', 'line_one_quantity', 'line_one_unit_price', 'line_one_total_price',
